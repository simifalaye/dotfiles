...
# Abort znap is not installed, run compinit manually
...
#
# Additional completion definitions: ohmyzsh and zsh-completions
#

znap install ohmyzsh/ohmyzsh zsh-users/zsh-completions
